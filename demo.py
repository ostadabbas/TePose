...
def main(args):
    ...
    checkpoint = torch.load('/mnt/Documents/Projects/HumanPoseEstimation/3D/VIBE/data/vibe_data/spin_model_checkpoint.pth.tar')
    ...
    save_name = f'{vid_name.replace(".mp4", "")}_TePose_output.mp4'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--vid_file', type=str, default='merged_courtyard_basketball_01.mp4', help='input video path or youtube link')

    parser.add_argument('--tracking_method', type=str, default='bbox', choices=['bbox', 'pose'],
                        help='tracking method to calculate the tracklet of a subject from the input video')

    parser.add_argument('--model', type=str, default='data/pretrained_models/tepose_wpw_3dpw_test.pth.tar', help='path to pretrained model weight')
