...
TePose_DB_DIR = 'data/preprocessed_data' #/scratch/wang.zhoup/datasets
...
cfg.TRAIN.UPDATE_THETA_RATE = 1.0
...
cfg.TRAIN.MOT_DISCR.NUM_CLASS = 2
...
cfg.TRAIN.MOT_DISCR.GCN = CN()
cfg.TRAIN.MOT_DISCR.GCN.num_class = 2
cfg.TRAIN.MOT_DISCR.GCN.num_point = 24
cfg.TRAIN.MOT_DISCR.GCN.num_person = 1
cfg.TRAIN.MOT_DISCR.GCN.num_gcn_scales = 13    # `num_scales` == `K + 1` in the paper
cfg.TRAIN.MOT_DISCR.GCN.num_g3d_scales = 6
cfg.TRAIN.MOT_DISCR.GCN.graph = 'lib.graph.smplx_theta.AdjMatrixGraph'

cfg.DATASET = CN()
cfg.DATASET.SEQLEN = 20
cfg.DATASET.VIDLEN = 1000
