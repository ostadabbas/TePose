...
class VIBE(nn.Module):
    def __init__(
            ...
            bidirectional=False,
            use_residual=True,
            pretrained='/mnt/Documents/Projects/HumanPoseEstimation/3D/VIBE/data/vibe_data/spin_model_checkpoint.pth.tar', #osp.join(TePose_DB_DIR, 'spin_model_checkpoint.pth.tar'),
    ):
...
class VIBE_Demo(nn.Module):
    def __init__(
            ...
            bidirectional=False,
            use_residual=True,
            pretrained=osp.join(TePose_DB_DIR, 'spin_model_checkpoint.pth.tar'),
    ):
